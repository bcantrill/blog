...
us to convey our ideas, but the very act forces us to test and distill them --
at once making our ideas more robust while providing the vehicle by which to
share them.
...
https://bcantrill.dtrace.org/2025/12/05/your-intellectual-fly-is-open/[the writer's intellectual fly is open].
In fact, it's _so_ jarring that I have to
...
https://writethatblog.substack.com/p/dev-reaction-to-ai-blog-posts[Cynthia Dunlop writes],
...
the piece:  71% of the respondents in Cynthia's survey _also_ "avoid the author
...
social media are _exactly_ the folks most likely to repost or otherwise promote
...
https://rfd.shared.oxide.computer/rfd/0576#_llms_as_writers[RFD 576],
...
or to otherwise pressure-test your own ideas -- the **only** purpose is to
...
2000s, we turned a corner: spam filtering improved so much that the _economics_
of spam were undermined.  Moreover, as spam became effectively contained, the
...
that their false negative rate was _far_ too high: they were chipper in
...
https://www.pangram.com/blog/pangram-3-0-technical[their Pangram 3 model].  I
...
A little over a month ago, they introduced
https://www.pangram.com/blog/pangram-4-technical[Pangram 4], which I found to
be a step-function improvement over the already-impressive Pangram 3: in my
experience it has an astonishingly low false positive rate _and_ low false
...
that I recently extended RFD 576 to be
https://rfd.shared.oxide.computer/rfd/0576#_llms_in_public_writing[explicit
...
for our public writing is not merely that LLMs aren't used to write, but that
**readers** have the confidence that it's not LLM-authored -- and increasingly
...
similar policy for those writing under their banner. (Looking squarely at you,
https://bsky.app/profile/sunshowers.io/post/3munl23rycc24[Rust Foundation]!)

Indeed, Pangram has become important to so many of us that I was thrilled when
Pangram Labs co-founder and CEO
https://oxide-and-friends.transistor.fm/episodes/ai-detection-with-max-spero[Max Spero joined us recently on _Oxide and Friends_].
I would recommend 
that discussion not only for the technical details of Pangram, but
also for Adam's drop of a pitch-perfect (if underappreciated in the moment)
_Simpsons_ reference: when I likened LLM-authored writing to presenting takeout
food as one's own cooking,
https://www.youtube.com/watch?v=5RdOf7d7hTE&t=533s[Adam quipped] that such
writing is like "steamed hams", making reference to
https://www.youtube.com/watch?v=4jXEuIHY9ic[Principal Skinner trying to pass
...
effective -- and why its efficacy seems to evince some
https://x.com/bcantrill/status/2093758464036413803[suspicious howls of protest].
...
you, of course --
https://rfd.shared.oxide.computer/rfd/0576#_llms_as_editors[LLMs are superlative editors]! -- 
just that you probably shouldn't let it write it for you if you actually expect
