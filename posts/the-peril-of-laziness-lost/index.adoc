...
In his classic 
https://en.wikipedia.org/wiki/Programming_Perl[_Programming Perl_] -- affectionately known to a generation of technologists as "the Camel Book" -- Larry Wall famously wrote of the three virtues of a programmer as laziness, impatience, and hubris:
...
https://www.youtube.com/watch?v=f84n5oFoZBc[hammock-driven development], we are in fact turning the problem over and over in our heads.
...
Pejoratively, this was the 
https://web.archive.org/web/20120304081438/http://www.businessweek.com/articles/2012-03-01/the-rise-of-the-brogrammer[rise of the brogrammer],
with the virtue of ironic laziness and hammock-driven development displaced by
https://www.urbandictionary.com/define.php?term=hustle+porn[hustle porn] about crushing code.
...
Take, for example, brogrammer-of-note
https://en.wikipedia.org/wiki/Garry_Tan[Garry Tan], who has been particularly insufferable about his LLM use, bragging about his rate of *thirty-seven thousand
lines of code per day* (and "still speeding up"):

image::images/37k-a-day-bro.webp[link=https://x.com/garrytan/status/2038555792052506941]

(For contrast, all of DTrace is -- depending on how you count it -- on the order of 
https://bcantrill.dtrace.org/2008/09/03/happy-5th-birthday-dtrace/houston.txt[sixty thousand lines of code].)
...
Polish software engineer Gregorein, however,
https://x.com/Gregorein/status/2038953944475472316[took it apart], and the results are at once predictable, hilarious and instructive:
...
This is what drives us to make the system _simpler_, despite its essential complexity.  As I expanded on in my talk
https://www.youtube.com/watch?v=Cum5uN2634o[The Complexity of Simplicity], this is a significant undertaking -- and we cannot
...
in our
https://rfd.shared.oxide.computer/rfd/0576#_llms_as_programmers[guidelines for LLM use at Oxide] -- they are but a tool.
We can put them to use tackling the non-ironic (and non-virtuous!) aspects of programmer laziness -- helping
us take on thorny problems like technical debt --  or 
https://oxide-and-friends.transistor.fm/episodes/engineering-rigor-in-the-llm-age[use them to promote our engineering rigor],
